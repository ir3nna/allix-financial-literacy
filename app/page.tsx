    ...
    <div className="flex flex-col gap-5">
      ...
      <motion.div initial={{ y: 10 }} animate={{ y: 0 }} className="relative">
        ...
        <img
          ...
          alt="Аликс"
          draggable={false}
          className="pointer-events-none absolute right-3 top-1/2 z-20 hidden h-[200px] w-auto -translate-y-[48%] select-none drop-shadow-xl sm:block md:right-8 md:h-[230px]"
        />
      </motion.div>
